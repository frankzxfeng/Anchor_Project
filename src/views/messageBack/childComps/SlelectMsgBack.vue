<template>
  <div class="select-msg-back">
    <div class="father-box">
      <el-card shadow="hover" v-show="isShow == true">
        <!-- 时间主搜索条件 -->
        ...
        <el-card shadow="hover">
          ...
          <div class="right1">
            <el-form label-position="right" label-width="80px">
              <el-form-item label="司机:">
                <el-input
                  v-model="formInputAlign.dirve"
                  placeholder="请输入司机姓名"
                  clearable
                ></el-input>
              </el-form-item>
              <el-form-item label="电话号码:" style="margin-bottom: 0px">
                <el-input
          ...
          <div class="right2">
            <el-form label-position="right" label-width="80px">
              ...
              <el-form-item label="护士:" style="margin-bottom: 0px">
                <el-input
            ...
            <el-form label-position="right" label-width="80px">
              <el-form-item label="现场地址:">
                <el-input
                  ...
                  placeholder="请输入现场地址"
                  clearable
                  @change="getSenceAddress"
                ></el-input>
              </el-form-item>
              <el-form-item label="短信状态:" style="margin-bottom: 0px">
                <el-select
...
export default {
  ...
  methods: {
    ...
    onSelect() {
      ...
      this.isShowSon = true;
      //请求短信回访数据
      localStorage.setItem("formDateTime","");
      localStorage.setItem("formInputAlign","");
      localStorage.setItem("subStnLable","");
      localStorage.setItem("ambulanceLable","");
      localStorage.setItem("msgStatusLable","");
      localStorage.setItem("formDateTime",JSON.stringify(this.formDateTime));
      localStorage.setItem("formInputAlign",JSON.stringify(this.formInputAlign));
      localStorage.setItem("subStnLable",this.subStnLable);
      localStorage.setItem("ambulanceLable",this.ambulanceLable);
      localStorage.setItem("msgStatusLable",this.msgStatusLable);
      // console.log(JSON.parse(localStorage.getItem("formDateTime")).startDate)
      getMsgAndCallBack(
    ...
    getStartDate() {
      // console.log("监听开始日期:" + this.formDateTime.startDate);
    },
    getEndDate() {
      // console.log("监听结束日期:" + this.formDateTime.endDate);
    },
    getStartTime() {
      // console.log("监听开始时间点:" + this.formDateTime.startTime);
    },
    getEndTime() {
      // console.log("监听结束时间点:" + this.formDateTime.endTime);
    },
    getTaskNum() {
      // console.log(this.formInputAlign.taskNum);
    },
    getPatientName() {
      // console.log(this.formInputAlign.patientName);
    },
    getPhoneNum() {
      // console.log(this.formInputAlign.phoneNum);
    },
    getSenceAddress() {},
    getSubStn(val) {
      //选择分站时触发的事件
      ...
      // console.log(res);
      this.subStnLable = val; //将分站编码作为参数
      // console.log(this.subStnLable);
      // console.log(val)
      //获取分站中的车辆
    ...
    showAmbulance() {
      ...
      // console.log(this.formSelectAlign.ambulanceOptions)
      if (
        this.formSelectAlign.subStnValue == "" &&
        this.formSelectAlign.ambulanceValue == ""
      ) {
        //如果没有选择分站
        this.formSelectAlign.ambulanceOptions.splice(
...
// @import "~assets/style/selectTime.less";//第一种方式
@import url("~assets/style/selectTime.less"); //第二种方式
</style>
